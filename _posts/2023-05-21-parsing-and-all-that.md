...
As you can see, we need at most 1 lookahead to deterministically parse this grammar, making it an LR(1) grammar. We're sometimes looking ahead to the end-of-input represented with `$`. 
